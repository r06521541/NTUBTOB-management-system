...
| `TASK-038` | `awaiting_owner_approval` | `owner` | 建議normal LINE Login恢復auto-login eligibility；state continuity失敗後才以fresh transaction啟用`disable_auto_login=true` browser fallback。 |
