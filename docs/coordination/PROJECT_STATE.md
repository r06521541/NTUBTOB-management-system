...
| `TASK-038` | `ready_for_codex` | `codex` | Owner已批准repository-only實作：normal LINE Login恢復auto-login eligibility，state continuity失敗後才以fresh transaction啟用browser fallback。 |
